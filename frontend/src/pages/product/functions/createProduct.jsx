...
const SubmitProduct = (event) => {
  ...
  axios.put(`${URL_PRODUCT}`, formData)
  .then((response) => {
  ...
  return (
    <>
      ...
      <form>
        ...
        <label id={"name"} htmlFor="" >Description du produit:</label>
        <input id="description" value={product.description} onChange={onChangeDescription} type="text" name="description"/>        
        <label id={"name"} htmlFor="" >Prix du produit:</label>
        <input id="price" type="text" value={product.price} onChange={onChangePrice} name="price"/>
